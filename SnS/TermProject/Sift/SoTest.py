...
t_start = time.time()
im_blurred = ImPreprocessing.gaussian_blur(im, 10)
...
Image.fromarray(uint8(im_blurred)).save(
    test_out_path + os.path.splitext(os.path.split(testfile)[1])[0] + "_out10_so_test.jpg")
